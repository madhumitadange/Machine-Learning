...
public class Vote {
    public static void main (String[] args)  throws Exception {
                ...
                String models[]={"F:\\J48.model","F:\\\\naiveb.model","F:\\\\smo3.model"};
              double arry [] ={0.25,0.25,0.5};
                    ...
                    if (file.isFile()) {
                        double j=0;
                         for(int i=0;i<models.length;i++){
                              ...
                              //j=0;
                   // System.out.println("Predicted : "+c.classify(testCoursepath+file.getName(),SMOmodel)+" By "+ SMOmodel);
...
//                 
                ...
                System.out.println("Acuurcy for  test Set:  "+100*(double)globalcnt/totalFiles + " Vote Classifier Acc");
     }
